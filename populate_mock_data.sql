-- Populate Mock Data for Loan Application System
...
-- Insert Affordable Housing Zone Data
INSERT INTO affordable_housing_zone (id, zipcode) VALUES
(1, 48202);
...
-- Insert some sample client-to-loan mappings
INSERT INTO clients_to_loan (customer_id, loan_id, loan_application_id, action_needed) VALUES
('CUST_1000', 1, 1000, 'Pending'),
('CUST_2000', 4, 1001, 'Pending'),
('CUST_3000', 3, 1002, 'Pending'),
('CUST_4000', 5, 1003, 'Approved'),
('CUST_5000', 2, 1004, 'Under Review'),
('CUST_6000', 1, 1005, 'Approved'),
('CUST_7000', 4, 1006, 'Rejected');
